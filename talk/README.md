...
The worked example is the pizza refund, all the way through. Why a judge at all,
...
deck is the one under the pipeline on slide 7: "We monitor the first five steps.
...
does not tell us how common that is. Slide 18 carries its limitation in the body.
Read it out loud.
...
## Run of show, 30 slides in 30 minutes

| Slides | Beat | Time |
|---|---|---|
| 1 to 2 | Title, then twenty seconds of who you are | 1:00 |
| 3 | The question the talk is about. Do not answer it | 0:20 |
| 4 | What is an AI agent, four boxes | 1:00 |
| 5 | What is LLM as a judge, four boxes | 1:00 |
| 6 to 8 | Ask who is hungry, where the order goes, it arrives wrong | 2:15 |
| 9 | What happens before the refund. The pipeline and the question | 1:00 |
| 10 to 11 | Why we used a judge, and what the judge receives | 1:45 |
| 12 | The first results looked fine | 0:45 |
| 13 to 14 | Hands up twice. Almost every hand goes down on the second | 1:10 |
| 15 | **The turn.** Some rows had no score | 1:00 |
| 16 to 17 | Six candidate causes, five ruled out | 1:40 |
| 18 | Ten inputs sent again, ten scored. Read the caution line | 1:00 |
| 19 | **Demo 1.** The same eight orders, three times | 1:30 |
| 20 | The missing scores were not spread evenly | 1:00 |
| 21 | **Demo 2.** What happens when we drop the blanks | 1:30 |
| 22 | The number went down because the hard cases came back | 0:40 |
| 23 | Divider. Where were the disagreements? | 0:15 |
| 24 to 25 | One example, then the same thing in my own work | 2:30 |
| 26 | What the judge was actually rewarding | 1:00 |
| 27 | Adding the reference changed the judge's behavior | 1:30 |
| 28 | **Demo 3.** What a second judge catches | 1:30 |
| 29 | What we check before trusting a judge number | 1:30 |
| 30 | Close, both QR codes | 0:30 |

Demos total roughly four and a half minutes across slides 19, 21 and 28.
...
Slide 25 is the one real anecdote: the mis grounded refusal from your own
...
Cut slides 8, 16, 25 and 27, and run only demos 1 and 3. The investigation
still closes.
...
numbers come out of real code, and take questions at slide 22 as well as at the end.
